...
description: Configures Sanity Visual Editing (Stega, Overlays, Presentation) for the current framework. Use when setting up preview mode or fixing overlays.
---
...
1.  **Detect Framework**
    ...
    *   Identify: `next`, `@remix-run/react`, `svelte`, `nuxt`, `astro`.
